          ...
          <div class="kt-iconbox__icon">
            ...
            <div class="kt-iconbox__desc">
              <h3 class="kt-iconbox__title">
                <a class="kt-link" href="{{route('tatanan1')}}">Kehidupan Masyarakat Sehat Mandiri</a>
              </h3>
        ...
        <div class="kt-portlet__body">
          <div class="kt-iconbox__body">
            <div class="kt-iconbox__icon">
              ...
              <div class="kt-iconbox__desc">
                <h3 class="kt-iconbox__title">
                  <a class="kt-link" href="#">Permukiman Dan Rumah Ibadat</a>
                </h3>
                <div class="kt-iconbox__content">
                  87
                </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Pasar Rakyat</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Satuan Pendidikan</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Pariwisata</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Transportasi Dan Tertib Lalu Lintas Jalan</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Perkantoran Dan Perindustrian</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Perlindungan Sosial</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
          ...
          <div class="kt-portlet__body">
            <div class="kt-iconbox__body">
              <div class="kt-iconbox__icon">
                ...
                <div class="kt-iconbox__desc">
                  <h3 class="kt-iconbox__title">
                    <a class="kt-link" href="#">Pencegahan Dan Penanganan Bencana</a>
                  </h3>
                  <div class="kt-iconbox__content">
                    87
                  </div>
